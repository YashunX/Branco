  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #040</strong><p>第二十一枝『出せない日の、ごみを目立たせない』を辛口評価して改善した。専用袋、見守り札、近隣通知、収集回数の公開を捨て、通常収集と福祉連携の役割分担へ絞った。</p></article>
