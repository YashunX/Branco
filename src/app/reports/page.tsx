...
export default function Reports() {
  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-candidate-section">
      ...
      <p className="story-section-intro">公開情報を出発点にした{briefs.length}案。根拠と仮説を分け、背景から最初の体験までを同じ順番で記す。人の確認が入るまでは、どれも完成案として扱わない。最新案は、診断名の必須入力、上司への病歴説明、同僚への一斉通知を入口から外し、職場が勤務調整の選択肢と情報の境界を先に渡す形へ絞った。</p>
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #046</strong><p>第二十六枝『治療のために、言い直さない』を辛口評価して改善した。診断名の必須入力、上司への病歴説明、同僚への一斉通知を捨て、勤務調整の選択肢と情報の境界を職場側が先に渡す形へ絞った。</p></article>
