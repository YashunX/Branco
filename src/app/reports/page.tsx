  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #039</strong><p>第二十枝『今日は、何もしないでここにいる』を辛口評価して改善した。活動選択、出席、面談、マッチングを捨て、選ばない余白と途中で変える権利を同じ大きさで置く形へ絞った。</p></article>
