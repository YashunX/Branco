...
export default function Reports() {
  ...
  return <div className="page-shell report-page story-report">
    <header className="story-hero">
      ...
      <p>これは過去の候補を引き継がず、白紙から始めた三本のストーリーである。応援したいのに輪へ入れない人、応援される木とその近くで日常を担う人、そして頼りたいのに頼みを言葉にできない人。それぞれの最初の瞬間から考え、一案は辛口評価で保留にした。</p>
    ...
    <section className="story-candidate-section">
      ...
      <p className="story-section-intro">公開情報を出発点にした三案。根拠と仮説を分け、背景から最初の体験までを同じ順番で記す。人の確認が入るまでは、どれも完成案として扱わない。最初の一案は、自己申告と星群の演出を不採用にして保留中である。</p>
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #009</strong><p>最初の一案を辛口評価し、初めてであることの自己申告と五秒の星群を不採用にした。会場参加の複数の障壁を一つの美しい演出で解かず、再発散待ちとして記録している。</p></article>
