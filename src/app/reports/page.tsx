  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #045</strong><p>第二十五枝『今日は、先に帰る』を辛口評価して改善した。家族の病名、介護内容、証明書、帰宅後の報告を捨て、理由を書かない一度きりの予定変更と相談先を分けて置いた。</p></article>
