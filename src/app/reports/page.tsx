  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #036</strong><p>第十八枝『返納した日の、最初の帰り道』を辛口評価して改善した。返納者バッジ、家族への決断通知、特典ランキング、返納予約への直結を捨て、本人が希望する一回の帰り道と別の選択肢だけを並べる形へ絞った。</p></article>
