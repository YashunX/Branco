...
export default function Reports() {
  ...
  return <div className="page-shell report-page story-report">
    <header className="story-hero">
      ...
      <p>これは過去の候補を引き継がず、白紙から始めた五本のストーリーである。応援したいのに輪へ入れない人、応援される木とその近くで日常を担う人、頼りたいのに頼みを言葉にできない人、応援した目標が終わる人、そして未完成を見せる前で立ち止まる人。それぞれの最初と終わりの瞬間から考え、一案は辛口評価で保留にした。</p>
    ...
    <section className="story-candidate-section">
      <div className="section-heading"><div><span className="card-label">ZERO-BASE HYPOTHESES / FIRST DRAFTS</span><h2>五つの応援の物語</h2></div><Sparkles size={20} /></div>
      <p className="story-section-intro">公開情報を出発点にした五案。根拠と仮説を分け、背景から最初の体験までを同じ順番で記す。人の確認が入るまでは、どれも完成案として扱わない。最初の一案は、自己申告と星群の演出を不採用にして保留中である。</p>
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #013</strong><p>五本目として『途中の机』をゼロから起案し、その場で辛口評価した。三種の定型反応と必須の一問を捨て、未完成の一点に一枚だけ返せる形へ絞った。</p></article>
