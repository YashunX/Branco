  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #043</strong><p>第二十四枝『避難所の外にも、今日の受け取り』を辛口評価して改善した。避難所外にいる理由、位置情報、世帯登録、受け取りの証明を捨て、自治体が当日の受け取り方と更新時刻を先に渡す形へ絞った。</p></article>
