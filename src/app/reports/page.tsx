  ...
  return <div className="page-shell report-page story-report">
    ...
    <section className="story-memo" aria-labelledby="production-memo-title">
      ...
      <div className="story-memo-facts">
        <article><span>今回の生成・更新</span><strong>{harness.updatedAt}<br />白紙化後 Loop #044</strong><p>第二十四枝『避難所の外にも、今日の受け取り』を辛口評価して改善した。配布場所だけを示す初稿を捨て、在庫の限り、配布終了、次の更新時刻、移動の相談を同じ案内に置いた。</p></article>
