...
export const harness = {
  ...
  preScreenBriefs: [
    ...
    },
    {
      ...
      prototype: "夏、木陰のそばに自治体・所有者の許可を得て小さな『木陰のしおり』を置く。しおりには木の名前も寄付額もなく、『この木陰を使ったら、秋に10分だけ返せます。』とだけ書かれている。秋、しおりのQRから落葉の30分清掃会を選び、参加者は最初の10分だけ落ち葉を集める。残りは地域の管理チームが担う。参加は記名なし、寄付・継続参加・SNS投稿を求めない。",
      whyThisForm: "夏に手に取るしおりが、木陰という受け取ったものと、秋の10分を同じ時間の線でつなぐ。アプリのポイントや常設のボランティア募集ではなく、木のそばで始まり、その木の落葉期にだけ終わる一回の関係にするため紙を使う。ただし、しおりが落葉の負担を美化したり、通行者に罪悪感を与えたりしないかは未検証である。",
      presentationScene: "夏の昼、通りかかった人が大きな木の下で水を飲む。ベンチ脇のしおりを一枚取る。秋の休日、その人は同じ木の下へ戻り、タイマーが鳴るまで10分だけ落ち葉を集める。袋を管理チームへ渡して、木の下を去る。",
      validation: "木陰を使ったことと落ち葉を集めることが、押しつけでなく自然につながるか。近隣住民・所有者・行政は、参加者が短時間だけ関わる設計を負担軽減として受け取れるか。清掃・安全・許可の責任を誰が担うか。",
      status: "人の確認待ち",
    },
  ...
  reviewQuestions: [
    ...
    {
      candidate: "木陰を返す",
      question: "夏に木陰のしおりを受け取り、秋に同じ木へ10分だけ戻ることは、木を応援する自然な入口に見えますか。それとも、木陰の利用者へ負債を作りますか。",
      whyItMatters: "負債に見えるなら、しおりや清掃会を改善せず、『恩恵を受けた人が返す』という前提自体を捨てる。",
    },
    {
      candidate: "木陰を返す",
      question: "近隣住民・木の所有者・行政にとって、10分だけ参加する人が増えることは本当に助けになりますか。逆に調整の負担を増やしませんか。",
  ...
  prototypePreviews: [{ id: "first-cheer-preview", title: "はじめての合図 / 最初の光", status: "改善候補 / 人の確認待ち", front: "今日が、はじめて。", inside: "私にも、最初があった。", interaction: "入場前に一人で選び、開演直前に区別のない星群として五秒だけ会場に現れる。" }, { id: "return-shade-preview", title: "木陰を返す / 木陰のしおり", status: "ゼロベース案 / 人の確認待ち", front: "この木陰を使ったら、", inside: "秋に10分だけ返せます。", interaction: "夏に一枚を取り、秋に同じ木へ戻って10分だけ落ち葉を集める。" }] satisfies PrototypePreview[],
  branches: [{
